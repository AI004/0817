 ...
 *  \return bool
 */
XINGYING_API bool XINGYING_CALLCONV XingYing_DecodeTimecode(unsigned int timecode, unsigned int timecodeSubframe,
                                                            int* pOutHour, int* pOutMinute, int* pOutSecond,
                                                            int* pOutFrame, int* pOutSubframe);
 ...
 *  \return bool
 */
XINGYING_API bool XINGYING_CALLCONV XingYing_TimecodeStringify(unsigned int timecode, unsigned int timecodeSubframe,
 ...
 *
 *  Some members of <paramref name="pDst"/> will be dynamically allocated. Call <see cref="XingYing_FreeFrame"/> to
 * deallocate them.
 *
 ...
 *
 *  The object pointed to by <paramref name="pFrame"/> itself is NOT de-allocated, only its nested members which were
 * dynamically allocated.
 *
 *  Warning: Do not call this on any <paramref name="pFrame"/> that was not the destination of a call to <see
 * cref="XingYing_CopyFrame"/>.
 *
 *  \param pFrame
 *
 *  \return XINGYING_API ErrorCode XINGYING_CALLCONV
