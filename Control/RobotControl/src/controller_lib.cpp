...
void Controller_Lib::pid_orient() {
  ...
  if (size_ == 6) {
    ...
    // pose_err.block(0,0,1,3) =
    // (basicfunction::VelProjectionMatrix_EulerXYZ(euler_a) *
    // euler_err).transpose();
    ...
    //        input_data_d.row(2)(4) + para(10)*(input_data_d.row(1)(4) -
    //        input_data_a.row(1)(4)) + para(4)*pose_err(4);
    //        output_data.row(2)(5) = input_data_d.row(2)(5) +
    //        para(11)*(input_data_d.row(1)(5) - input_data_a.row(1)(5)) +
    //        para(5)*pose_err(5);
  } else if (size_ == 4) {
    ...
    //        input_data_d.row(2)(5) + para(11)*(input_data_d.row(1)(5) -
    //        input_data_a.row(1)(5)) + para(5)*pose_err(5);
  } else {
    output_data = input_data_d;
  }

  // F
  //    output_data.row(3) = input_data_d.row(3);// +
  //    para(0)*(input_data_d.row(3) - input_data_a.row(3));
