...
class Joystick_humanoid {
 public:
  ...
  // x - direction
  double maxspeed_x = 0.6;
  // x + direction
  double minspeed_x = -1.0;
  ...
  double maxspeed_yaw = 1.0;
  double minspeed_yaw = -1.0;
  ...
  double get_stand_yaw_direction_posiiton();
  double maxposition_yaw = 0.25;
  double minposition_yaw = -0.25;
