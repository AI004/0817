...
bool checkDllValidity(const std::string &dllName,
...
#else
#if defined _LINUX
  // TODO : To avoid lots of rework I am simply making this return true if
  // _LINUX is defined Once this is implemented for Linux rework will be minimal
  return true;
#else
