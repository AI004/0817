...
template <size_t tdim, typename T = float> struct vec {
  // Public Members /////////////////////////////////////////////////////////
...
// The operator* and operator/ throw a warning when a vec*f is multiplied by a
// double.
#pragma warning(disable : 4244)
#endif
...
/// \brief 2-component vector using <c>long double</c> as its underlying data
/// type.
typedef vec<2, long double> vec2ld;

/// \brief 3-component vector using <c>long double</c> as its underlying data
/// type.
typedef vec<3, long double> vec3ld;

/// \brief 4-component vector using <c>long double</c> as its underlying data
/// type.
