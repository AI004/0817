...
template <size_t m, size_t n = m, typename T = float> struct mat {
  // Public Members /////////////////////////////////////////////////////////
...
public:
  ...
  template <typename S> mat &operator*=(const S &rhs) {
  ...
  template <typename S> mat &operator/=(const T &rhs) {
    for (size_t i = 0; i < m * n; i++)
      e[i] /= rhs;
  ...
  template <typename S> mat &operator+=(const mat<m, n, S> &rhs) {
    for (size_t i = 0; i < m * n; i++)
      e[i] += rhs.e[i];
...
public:
  ...
  mat(T e00v, T e01v, T e10v, T e11v)
      : e00(e00v), e10(e10v), e01(e01v), e11(e11v) {}
  ...
  mat(vec<2, T> col0, vec<2, T> col1)
      : e00(col0.x), e10(col1.x), e01(col0.y), e11(col1.y) {}
...
#pragma warning(pop)
  ...
  /// \param[in] rhs The other matrix.
  /// \return The multiplied matrix.
  template <typename S> mat &operator*=(const mat<2, 2, S> &rhs) {
    size_t row = 0;
    size_t col = 0;
    size_t cell = 0;
...
public:
  ...
  template <typename S> void copy(const mat<2, 2, S> rhs) { *this = rhs; }
...
public:
  ...
  /// \param[in] val The initialization value.
  explicit mat(T val)
      : e00(val), e10(val), e20(val), e01(val), e11(val), e21(val), e02(val),
        e12(val), e22(val) {}
  ...
  mat(T e00v, T e01v, T e02v, T e10v, T e11v, T e12v, T e20v, T e21v, T e22v)
      : e00(e00v), e10(e10v), e20(e20v), e01(e01v), e11(e11v), e21(e21v),
        e02(e02v), e12(e12v), e22(e22v)

  {}

  /// \brief Constructs a matrix from 3 column vectors.  Vectors are stored in
  /// column order
  ///
  /// \param[in] col0 The 0 column vector.
  /// \param[in] col1 The 1 column vector.
  ...
  mat(vec<3, T> col0, vec<3, T> col1, vec<3, T> col2)
      : e00(col0.x), e10(col0.y), e20(col0.z), e01(col1.x), e11(col1.y),
        e21(col1.z), e02(col2.x), e12(col2.y), e22(col2.z) {}
...
#pragma warning(pop)
  ...
  /// \param[in] rhs The other matrix.
  /// \return The multiplied matrix.
  template <typename S> mat &operator*=(const mat<3, 3, S> &rhs) {
    size_t counter = 0;
    size_t row = 0;
    size_t col = 0;
    size_t cell = 0;
...
public:
  ...
  template <typename S> void copy(const mat<3, 3, S> &rhs) { *this = rhs; }
...
public:
  ...
  /// \param[in] val The initialization value.
  explicit mat(T val)
      : e00(val), e01(val), e02(val), e03(val), e10(val), e11(val), e12(val),
        e13(val), e20(val), e21(val), e22(val), e23(val), e30(val), e31(val),
        e32(val), e33(val) {}
  ...
  mat(T e00v, T e01v, T e02v, T e03v, T e10v, T e11v, T e12v, T e13v, T e20v,
      T e21v, T e22v, T e23v, T e30v, T e31v, T e32v, T e33v)
      : e00(e00v), e01(e01v), e02(e02v), e03(e03v), e10(e10v), e11(e11v),
        e12(e12v), e13(e13v), e20(e20v), e21(e21v), e22(e22v), e23(e23v),
  ...
  mat(vec<4, T> col0, vec<4, T> col1, vec<4, T> col2, vec<4, T> col3)
      : e00(col0.x), e10(col1.x), e20(col2.x), e30(col3.x), e01(col0.y),
        e11(col1.y), e21(col2.y), e31(col3.y), e02(col0.z), e12(col1.z),
        e22(col2.z), e32(col3.z), e03(col0.w), e13(col1.w), e23(col2.w),
        e33(col3.w) {}
...
#pragma warning(pop)
  ...
  /// \param[in] rhs The other matrix.
  /// \return The multiplied matrix.
  template <typename S> mat &operator*=(const mat<4, 4, S> &rhs) {
    size_t row = 0;
    size_t col = 0;
    size_t cell = 0;
...
public:
  ...
  template <typename S> void copy(const mat<4, 4, S> &rhs) { *this = rhs; }
