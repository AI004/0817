...
struct BinaryOutputRegister {
  ...
  BinaryOutputRegister()
      : asyncMode(protocol::uart::ASYNCMODE_NONE), rateDivisor(0),
  ...
  BinaryOutputRegister(protocol::uart::AsyncMode asyncModeIn,
      ...
      : asyncMode(asyncModeIn), rateDivisor(rateDivisorIn),
        commonField(commonFieldIn), timeField(timeFieldIn),
        imuField(imuFieldIn), gpsField(gpsFieldIn),
        attitudeField(attitudeFieldIn), insField(insFieldIn),
        gps2Field(gps2FieldIn) {}

  BinaryOutputRegister(uint16_t asyncModeIn, uint16_t rateDivisorIn,
                       uint16_t commonFieldIn, uint16_t timeFieldIn,
                       uint16_t imuFieldIn, uint16_t gpsFieldIn,
                       uint16_t attitudeFieldIn, uint16_t insFieldIn,
      ...
      : asyncMode(static_cast<protocol::uart::AsyncMode>(asyncModeIn)),
        ...
        attitudeField(
            static_cast<protocol::uart::AttitudeGroup>(attitudeFieldIn)),
        insField(static_cast<protocol::uart::InsGroup>(insFieldIn)),
        gps2Field(static_cast<protocol::uart::GpsGroup>(gps2FieldIn)) {}
};

/// \brief Structure representing the Quaternion, Magnetic, Acceleration and
...
struct QuaternionMagneticAccelerationAndAngularRatesRegister {
  ...
  /// \brief Creates an initializes a new
  /// QuaternionMagneticAccelerationAndAngularRatesRegister structure.
  ///
  ...
  QuaternionMagneticAccelerationAndAngularRatesRegister(vn::math::vec4f quatIn,
                                                        vn::math::vec3f magIn,
...
/// \brief Structure representing the Magnetic, Acceleration and Angular Rates
/// register.
struct MagneticAccelerationAndAngularRatesRegister {
  ...
  /// \brief Creates an initializes a new
  /// MagneticAccelerationAndAngularRatesRegister structure.
  ///
  /// \param[in] magIn Value to initialize the mag field with.
  /// \param[in] accelIn Value to initialize the accel field with.
  /// \param[in] gyroIn Value to initialize the gyro field with.
  MagneticAccelerationAndAngularRatesRegister(vn::math::vec3f magIn,
                                              vn::math::vec3f accelIn,
                                              vn::math::vec3f gyroIn)
      : mag(magIn), accel(accelIn), gyro(gyroIn) {}
};

/// \brief Structure representing the Magnetic and Gravity Reference Vectors
/// register.
struct MagneticAndGravityReferenceVectorsRegister {
  ...
  /// \brief Creates an initializes a new
  /// MagneticAndGravityReferenceVectorsRegister structure.
  ///
  /// \param[in] magRefIn Value to initialize the magRef field with.
  /// \param[in] accRefIn Value to initialize the accRef field with.
  MagneticAndGravityReferenceVectorsRegister(vn::math::vec3f magRefIn,
                                             vn::math::vec3f accRefIn)
      : magRef(magRefIn), accRef(accRefIn) {}
};

/// \brief Structure representing the Filter Measurements Variance Parameters
/// register.
struct FilterMeasurementsVarianceParametersRegister {
  ...
  /// \brief Creates an initializes a new
  /// FilterMeasurementsVarianceParametersRegister structure.
  ///
  /// \param[in] angularWalkVarianceIn Value to initialize the
  /// angularWalkVariance field with. \param[in] angularRateVarianceIn Value to
  /// initialize the angularRateVariance field with. \param[in]
  /// magneticVarianceIn Value to initialize the magneticVariance field with.
  /// \param[in] accelerationVarianceIn Value to initialize the
  /// accelerationVariance field with.
  FilterMeasurementsVarianceParametersRegister(
...
struct MagnetometerCompensationRegister {
  ...
  /// \brief Creates an initializes a new MagnetometerCompensationRegister
  /// structure.
  ///
...
struct FilterActiveTuningParametersRegister {
  ...
  float accelerationDisturbanceMemory; ///< The accelerationDisturbanceMemory
                                       ///< field.

  FilterActiveTuningParametersRegister() {}

  /// \brief Creates an initializes a new FilterActiveTuningParametersRegister
  /// structure.
  ///
  /// \param[in] magneticDisturbanceGainIn Value to initialize the
  /// magneticDisturbanceGain field with. \param[in]
  /// accelerationDisturbanceGainIn Value to initialize the
  /// accelerationDisturbanceGain field with. \param[in]
  /// magneticDisturbanceMemoryIn Value to initialize the
  /// magneticDisturbanceMemory field with. \param[in]
  /// accelerationDisturbanceMemoryIn Value to initialize the
  /// accelerationDisturbanceMemory field with.
  FilterActiveTuningParametersRegister(float magneticDisturbanceGainIn,
...
struct AccelerationCompensationRegister {
  ...
  /// \brief Creates an initializes a new AccelerationCompensationRegister
  /// structure.
  ///
  /// \param[in] cIn Value to initialize the c field with.
  /// \param[in] bIn Value to initialize the b field with.
...
/// \brief Structure representing the Yaw, Pitch, Roll, Magnetic, Acceleration
...
struct YawPitchRollMagneticAccelerationAndAngularRatesRegister {
  ...
  /// \brief Creates an initializes a new
  /// YawPitchRollMagneticAccelerationAndAngularRatesRegister structure.
  ///
  ...
  /// \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollMagneticAccelerationAndAngularRatesRegister(
      vn::math::vec3f yawPitchRollIn, vn::math::vec3f magIn,
      vn::math::vec3f accelIn, vn::math::vec3f gyroIn)
...
struct CommunicationProtocolControlRegister {
  ...
  /// \brief Creates an initializes a new CommunicationProtocolControlRegister
  /// structure.
  ///
  ...
  /// \param[in] serialChecksumIn Value to initialize the serialChecksum field
  /// with. \param[in] spiChecksumIn Value to initialize the spiChecksum field
  /// with. \param[in] errorModeIn Value to initialize the errorMode field with.
  CommunicationProtocolControlRegister(
      ...
      : serialCount(serialCountIn), serialStatus(serialStatusIn),
        spiCount(spiCountIn), spiStatus(spiStatusIn),
        serialChecksum(serialChecksumIn), spiChecksum(spiChecksumIn),
...
struct SynchronizationControlRegister {
  ...
  protocol::uart::SyncOutPolarity
      syncOutPolarity;        ///< The syncOutPolarity field.
  ...
  /// \brief Creates an initializes a new SynchronizationControlRegister
  /// structure.
  ///
  ...
  /// \param[in] syncInSkipFactorIn Value to initialize the syncInSkipFactor
  /// field with. \param[in] syncOutModeIn Value to initialize the syncOutMode
  /// field with. \param[in] syncOutPolarityIn Value to initialize the
  /// syncOutPolarity field with. \param[in] syncOutSkipFactorIn Value to
  /// initialize the syncOutSkipFactor field with. \param[in]
  /// syncOutPulseWidthIn Value to initialize the syncOutPulseWidth field with.
  SynchronizationControlRegister(
      protocol::uart::SyncInMode syncInModeIn,
      protocol::uart::SyncInEdge syncInEdgeIn, uint16_t syncInSkipFactorIn,
      protocol::uart::SyncOutMode syncOutModeIn,
      protocol::uart::SyncOutPolarity syncOutPolarityIn,
      uint16_t syncOutSkipFactorIn, uint32_t syncOutPulseWidthIn)
      : syncInMode(syncInModeIn), syncInEdge(syncInEdgeIn),
        syncInSkipFactor(syncInSkipFactorIn), syncOutMode(syncOutModeIn),
...
struct SynchronizationStatusRegister {
  ...
  /// \brief Creates an initializes a new SynchronizationStatusRegister
  /// structure.
  ///
  ...
  SynchronizationStatusRegister(uint32_t syncInCountIn, uint32_t syncInTimeIn,
...
struct FilterBasicControlRegister {
  ...
  FilterBasicControlRegister(protocol::uart::MagneticMode magModeIn,
      ...
      : magMode(magModeIn), extMagMode(extMagModeIn), extAccMode(extAccModeIn),
        extGyroMode(extGyroModeIn), gyroLimit(gyroLimitIn) {}
};
...
struct VpeBasicControlRegister {
  ...
  /// \param[in] filteringModeIn Value to initialize the filteringMode field
  /// with. \param[in] tuningModeIn Value to initialize the tuningMode field
  /// with.
  VpeBasicControlRegister(protocol::uart::VpeEnable enableIn,
                          protocol::uart::HeadingMode headingModeIn,
                          protocol::uart::VpeMode filteringModeIn,
                          protocol::uart::VpeMode tuningModeIn)
      : enable(enableIn), headingMode(headingModeIn),
        filteringMode(filteringModeIn), tuningMode(tuningModeIn) {}
};
...
struct VpeMagnetometerBasicTuningRegister {
  ...
  /// \brief Creates an initializes a new VpeMagnetometerBasicTuningRegister
  /// structure.
  ///
  /// \param[in] baseTuningIn Value to initialize the baseTuning field with.
  /// \param[in] adaptiveTuningIn Value to initialize the adaptiveTuning field
  /// with. \param[in] adaptiveFilteringIn Value to initialize the
  /// adaptiveFiltering field with.
  VpeMagnetometerBasicTuningRegister(vn::math::vec3f baseTuningIn,
                                     vn::math::vec3f adaptiveTuningIn,
                                     vn::math::vec3f adaptiveFilteringIn)
      : baseTuning(baseTuningIn), adaptiveTuning(adaptiveTuningIn),
...
struct VpeMagnetometerAdvancedTuningRegister {
  ...
  /// \brief Creates an initializes a new VpeMagnetometerAdvancedTuningRegister
  /// structure.
  ///
  ...
  /// \param[in] disturbanceWindowIn Value to initialize the disturbanceWindow
  /// field with. \param[in] maxTuningIn Value to initialize the maxTuning field
  /// with.
  VpeMagnetometerAdvancedTuningRegister(vn::math::vec3f minFilteringIn,
                                        vn::math::vec3f maxFilteringIn,
                                        float maxAdaptRateIn,
                                        float disturbanceWindowIn,
                                        float maxTuningIn)
      : minFiltering(minFilteringIn), maxFiltering(maxFilteringIn),
        maxAdaptRate(maxAdaptRateIn), disturbanceWindow(disturbanceWindowIn),
...
struct VpeAccelerometerBasicTuningRegister {
  ...
  /// \brief Creates an initializes a new VpeAccelerometerBasicTuningRegister
  /// structure.
  ///
  /// \param[in] baseTuningIn Value to initialize the baseTuning field with.
  /// \param[in] adaptiveTuningIn Value to initialize the adaptiveTuning field
  /// with. \param[in] adaptiveFilteringIn Value to initialize the
  /// adaptiveFiltering field with.
  VpeAccelerometerBasicTuningRegister(vn::math::vec3f baseTuningIn,
                                      vn::math::vec3f adaptiveTuningIn,
                                      vn::math::vec3f adaptiveFilteringIn)
      : baseTuning(baseTuningIn), adaptiveTuning(adaptiveTuningIn),
        adaptiveFiltering(adaptiveFilteringIn) {}
...
/// \brief Structure representing the VPE Accelerometer Advanced Tuning
/// register.
struct VpeAccelerometerAdvancedTuningRegister {
  ...
  /// \brief Creates an initializes a new VpeAccelerometerAdvancedTuningRegister
  /// structure.
  ///
  /// \param[in] minFilteringIn Value to initialize the minFiltering field with.
  /// \param[in] maxFilteringIn Value to initialize the maxFiltering field with.
  ...
  /// field with. \param[in] maxTuningIn Value to initialize the maxTuning field
  /// with.
  VpeAccelerometerAdvancedTuningRegister(vn::math::vec3f minFilteringIn,
                                         vn::math::vec3f maxFilteringIn,
                                         float maxAdaptRateIn,
                                         float disturbanceWindowIn,
                                         float maxTuningIn)
...
struct VpeGyroBasicTuningRegister {
  ...
  ///
  /// \param[in] angularWalkVarianceIn Value to initialize the
  /// angularWalkVariance field with. \param[in] baseTuningIn Value to
  /// initialize the baseTuning field with. \param[in] adaptiveTuningIn Value to
  /// initialize the adaptiveTuning field with.
  VpeGyroBasicTuningRegister(vn::math::vec3f angularWalkVarianceIn,
                             vn::math::vec3f baseTuningIn,
                             vn::math::vec3f adaptiveTuningIn)
      : angularWalkVariance(angularWalkVarianceIn), baseTuning(baseTuningIn),
...
struct MagnetometerCalibrationControlRegister {
  ...
  /// \brief Creates an initializes a new MagnetometerCalibrationControlRegister
  /// structure.
  ///
  ...
  MagnetometerCalibrationControlRegister(protocol::uart::HsiMode hsiModeIn,
                                         protocol::uart::HsiOutput hsiOutputIn,
                                         uint8_t convergeRateIn)
      : hsiMode(hsiModeIn), hsiOutput(hsiOutputIn),
        convergeRate(convergeRateIn) {}
};

/// \brief Structure representing the Calculated Magnetometer Calibration
/// register.
struct CalculatedMagnetometerCalibrationRegister {
  ...
  /// \brief Creates an initializes a new
  /// CalculatedMagnetometerCalibrationRegister structure.
  ///
  /// \param[in] cIn Value to initialize the c field with.
  /// \param[in] bIn Value to initialize the b field with.
  CalculatedMagnetometerCalibrationRegister(vn::math::mat3f cIn,
                                            vn::math::vec3f bIn)
      : c(cIn), b(bIn) {}
};
...
struct VelocityCompensationControlRegister {
  ...
  /// \brief Creates an initializes a new VelocityCompensationControlRegister
  /// structure.
  ///
  /// \param[in] modeIn Value to initialize the mode field with.
  /// \param[in] velocityTuningIn Value to initialize the velocityTuning field
  /// with. \param[in] rateTuningIn Value to initialize the rateTuning field
  /// with.
  VelocityCompensationControlRegister(
      protocol::uart::VelocityCompensationMode modeIn, float velocityTuningIn,
      float rateTuningIn)
      : mode(modeIn), velocityTuning(velocityTuningIn),
...
struct VelocityCompensationStatusRegister {
  ...
  /// \brief Creates an initializes a new VelocityCompensationStatusRegister
  /// structure.
  ///
  ...
  VelocityCompensationStatusRegister(float xIn, float xDotIn,
...
struct ImuMeasurementsRegister {
  ...
  ImuMeasurementsRegister(vn::math::vec3f magIn, vn::math::vec3f accelIn,
                          vn::math::vec3f gyroIn, float tempIn,
                          float pressureIn)
      : mag(magIn), accel(accelIn), gyro(gyroIn), temp(tempIn),
        pressure(pressureIn) {}
};
...
struct GpsConfigurationRegister {
  ...
  GpsConfigurationRegister(protocol::uart::GpsMode modeIn,
                           protocol::uart::PpsSource ppsSourceIn)
      : mode(modeIn), ppsSource(ppsSourceIn) {}
};
...
struct GpsSolutionLlaRegister {
  ...
  GpsSolutionLlaRegister(double timeIn, uint16_t weekIn,
                         protocol::uart::GpsFix gpsFixIn, uint8_t numSatsIn,
                         vn::math::vec3d llaIn, vn::math::vec3f nedVelIn,
                         vn::math::vec3f nedAccIn, float speedAccIn,
                         float timeAccIn)
      : time(timeIn), week(weekIn), gpsFix(gpsFixIn), numSats(numSatsIn),
        lla(llaIn), nedVel(nedVelIn), nedAcc(nedAccIn), speedAcc(speedAccIn),
        timeAcc(timeAccIn) {}
};
...
struct GpsSolutionEcefRegister {
  ...
  /// \param[in] speedAccIn Value to initialize the speedAcc field with.
  /// \param[in] timeAccIn Value to initialize the timeAcc field with.
  GpsSolutionEcefRegister(double towIn, uint16_t weekIn,
                          protocol::uart::GpsFix gpsFixIn, uint8_t numSatsIn,
                          vn::math::vec3d positionIn,
                          vn::math::vec3f velocityIn, vn::math::vec3f posAccIn,
                          float speedAccIn, float timeAccIn)
      : tow(towIn), week(weekIn), gpsFix(gpsFixIn), numSats(numSatsIn),
        position(positionIn), velocity(velocityIn), posAcc(posAccIn),
        speedAcc(speedAccIn), timeAcc(timeAccIn) {}
};
...
struct InsSolutionLlaRegister {
  ...
  /// \param[in] positionIn Value to initialize the position field with.
  /// \param[in] nedVelIn Value to initialize the nedVel field with.
  /// \param[in] attUncertaintyIn Value to initialize the attUncertainty field
  /// with. \param[in] posUncertaintyIn Value to initialize the posUncertainty
  /// field with. \param[in] velUncertaintyIn Value to initialize the
  /// velUncertainty field with.
  InsSolutionLlaRegister(double timeIn, uint16_t weekIn, uint16_t statusIn,
                         vn::math::vec3f yawPitchRollIn,
                         vn::math::vec3d positionIn, vn::math::vec3f nedVelIn,
                         float attUncertaintyIn, float posUncertaintyIn,
                         float velUncertaintyIn)
      : time(timeIn), week(weekIn), status(statusIn),
        yawPitchRoll(yawPitchRollIn), position(positionIn), nedVel(nedVelIn),
        attUncertainty(attUncertaintyIn), posUncertainty(posUncertaintyIn),
...
struct InsSolutionEcefRegister {
  ...
  /// field with. \param[in] velUncertaintyIn Value to initialize the
  /// velUncertainty field with.
  InsSolutionEcefRegister(double timeIn, uint16_t weekIn, uint16_t statusIn,
                          vn::math::vec3f yawPitchRollIn,
                          vn::math::vec3d positionIn,
                          vn::math::vec3f velocityIn, float attUncertaintyIn,
                          float posUncertaintyIn, float velUncertaintyIn)
      : time(timeIn), week(weekIn), status(statusIn),
        yawPitchRoll(yawPitchRollIn), position(positionIn),
        velocity(velocityIn), attUncertainty(attUncertaintyIn),
        posUncertainty(posUncertaintyIn), velUncertainty(velUncertaintyIn) {}
};

/// \brief Structure representing the INS Basic Configuration register for a
/// VN-200 sensor.
struct InsBasicConfigurationRegisterVn200 {
  ...
  /// \brief Creates an initializes a new InsBasicConfigurationRegisterVn200
  /// structure.
  ///
  ...
  InsBasicConfigurationRegisterVn200(protocol::uart::Scenario scenarioIn,
                                     bool ahrsAidingIn)
...
struct InsBasicConfigurationRegisterVn300 {
  ...
  /// \brief Creates an initializes a new InsBasicConfigurationRegisterVn300
  /// structure.
  ///
  /// \param[in] scenarioIn Value to initialize the scenario field with.
  /// \param[in] ahrsAidingIn Value to initialize the ahrsAiding field with.
  /// \param[in] estBaselineIn Value to initialize the estBaseline field with.
  InsBasicConfigurationRegisterVn300(protocol::uart::Scenario scenarioIn,
                                     bool ahrsAidingIn, bool estBaselineIn)
      : scenario(scenarioIn), ahrsAiding(ahrsAidingIn),
...
struct InsAdvancedConfigurationRegister {
  ...
  /// \brief Creates an initializes a new InsAdvancedConfigurationRegister
  /// structure.
  ///
  ...
  /// \param[in] deltaLimitPosIn Value to initialize the deltaLimitPos field
  /// with. \param[in] deltaLimitVelIn Value to initialize the deltaLimitVel
  /// field with. \param[in] minPosUncertaintyIn Value to initialize the
  /// minPosUncertainty field with. \param[in] minVelUncertaintyIn Value to
  /// initialize the minVelUncertainty field with.
  InsAdvancedConfigurationRegister(
      bool useMagIn, bool usePresIn, bool posAttIn, bool velAttIn,
      bool velBiasIn, protocol::uart::FoamInit useFoamIn, uint8_t gpsCovTypeIn,
      uint8_t velCountIn, float velInitIn, float moveOriginIn,
      float gpsTimeoutIn, float deltaLimitPosIn, float deltaLimitVelIn,
      float minPosUncertaintyIn, float minVelUncertaintyIn)
      : useMag(useMagIn), usePres(usePresIn), posAtt(posAttIn),
        velAtt(velAttIn), velBias(velBiasIn), useFoam(useFoamIn),
        gpsCovType(gpsCovTypeIn), velCount(velCountIn), velInit(velInitIn),
        moveOrigin(moveOriginIn), gpsTimeout(gpsTimeoutIn),
        deltaLimitPos(deltaLimitPosIn), deltaLimitVel(deltaLimitVelIn),
...
struct InsStateLlaRegister {
  ...
  InsStateLlaRegister(vn::math::vec3f yawPitchRollIn,
                      vn::math::vec3d positionIn, vn::math::vec3f velocityIn,
                      vn::math::vec3f accelIn, vn::math::vec3f angularRateIn)
      : yawPitchRoll(yawPitchRollIn), position(positionIn),
        velocity(velocityIn), accel(accelIn), angularRate(angularRateIn) {}
};
...
struct InsStateEcefRegister {
  ...
  /// \param[in] accelIn Value to initialize the accel field with.
  /// \param[in] angularRateIn Value to initialize the angularRate field with.
  InsStateEcefRegister(vn::math::vec3f yawPitchRollIn,
                       vn::math::vec3d positionIn, vn::math::vec3f velocityIn,
                       vn::math::vec3f accelIn, vn::math::vec3f angularRateIn)
      : yawPitchRoll(yawPitchRollIn), position(positionIn),
        velocity(velocityIn), accel(accelIn), angularRate(angularRateIn) {}
...
struct StartupFilterBiasEstimateRegister {
  ...
  /// \brief Creates an initializes a new StartupFilterBiasEstimateRegister
  /// structure.
  ///
  ...
  StartupFilterBiasEstimateRegister(vn::math::vec3f gyroBiasIn,
                                    vn::math::vec3f accelBiasIn,
                                    float pressureBiasIn)
      : gyroBias(gyroBiasIn), accelBias(accelBiasIn),
...
struct DeltaThetaAndDeltaVelocityRegister {
  ...
  /// \brief Creates an initializes a new DeltaThetaAndDeltaVelocityRegister
  /// structure.
  ///
  ...
  /// \param[in] deltaVelocityIn Value to initialize the deltaVelocity field
  /// with.
  DeltaThetaAndDeltaVelocityRegister(float deltaTimeIn,
                                     vn::math::vec3f deltaThetaIn,
                                     vn::math::vec3f deltaVelocityIn)
      : deltaTime(deltaTimeIn), deltaTheta(deltaThetaIn),
        deltaVelocity(deltaVelocityIn) {}
};

/// \brief Structure representing the Delta Theta and Delta Velocity
/// Configuration register.
struct DeltaThetaAndDeltaVelocityConfigurationRegister {
  protocol::uart::IntegrationFrame
      integrationFrame; ///< The integrationFrame field.
  protocol::uart::CompensationMode
      gyroCompensation; ///< The gyroCompensation field.
  protocol::uart::CompensationMode
      accelCompensation; ///< The accelCompensation field.

  DeltaThetaAndDeltaVelocityConfigurationRegister() {}

  /// \brief Creates an initializes a new
  /// DeltaThetaAndDeltaVelocityConfigurationRegister structure.
  ///
  /// \param[in] integrationFrameIn Value to initialize the integrationFrame
  /// field with. \param[in] gyroCompensationIn Value to initialize the
  /// gyroCompensation field with. \param[in] accelCompensationIn Value to
  /// initialize the accelCompensation field with.
  DeltaThetaAndDeltaVelocityConfigurationRegister(
...
struct ReferenceVectorConfigurationRegister {
  ...
  /// \brief Creates an initializes a new ReferenceVectorConfigurationRegister
  /// structure.
  ///
  /// \param[in] useMagModelIn Value to initialize the useMagModel field with.
  /// \param[in] useGravityModelIn Value to initialize the useGravityModel field
  /// with. \param[in] recalcThresholdIn Value to initialize the recalcThreshold
  /// field with. \param[in] yearIn Value to initialize the year field with.
  /// \param[in] positionIn Value to initialize the position field with.
  ReferenceVectorConfigurationRegister(bool useMagModelIn,
                                       bool useGravityModelIn,
                                       uint32_t recalcThresholdIn, float yearIn,
                                       vn::math::vec3d positionIn)
      : useMagModel(useMagModelIn), useGravityModel(useGravityModelIn),
        recalcThreshold(recalcThresholdIn), year(yearIn), position(positionIn) {
  }
};
...
struct ImuFilteringConfigurationRegister {
  ...
  /// \brief Creates an initializes a new ImuFilteringConfigurationRegister
  /// structure.
  ///
  /// \param[in] magWindowSizeIn Value to initialize the magWindowSize field
  /// with. \param[in] accelWindowSizeIn Value to initialize the accelWindowSize
  /// field with. \param[in] gyroWindowSizeIn Value to initialize the
  /// gyroWindowSize field with. \param[in] tempWindowSizeIn Value to initialize
  /// the tempWindowSize field with. \param[in] presWindowSizeIn Value to
  /// initialize the presWindowSize field with. \param[in] magFilterModeIn Value
  /// to initialize the magFilterMode field with. \param[in] accelFilterModeIn
  /// Value to initialize the accelFilterMode field with. \param[in]
  /// gyroFilterModeIn Value to initialize the gyroFilterMode field with.
  /// \param[in] tempFilterModeIn Value to initialize the tempFilterMode field
  /// with. \param[in] presFilterModeIn Value to initialize the presFilterMode
  /// field with.
  ImuFilteringConfigurationRegister(
      uint16_t magWindowSizeIn, uint16_t accelWindowSizeIn,
      uint16_t gyroWindowSizeIn, uint16_t tempWindowSizeIn,
      uint16_t presWindowSizeIn, protocol::uart::FilterMode magFilterModeIn,
      ...
      : magWindowSize(magWindowSizeIn), accelWindowSize(accelWindowSizeIn),
        gyroWindowSize(gyroWindowSizeIn), tempWindowSize(tempWindowSizeIn),
        presWindowSize(presWindowSizeIn), magFilterMode(magFilterModeIn),
        accelFilterMode(accelFilterModeIn), gyroFilterMode(gyroFilterModeIn),
        tempFilterMode(tempFilterModeIn), presFilterMode(presFilterModeIn) {}
};
...
struct GpsCompassBaselineRegister {
  ...
  GpsCompassBaselineRegister(vn::math::vec3f positionIn,
...
struct GpsCompassEstimatedBaselineRegister {
  ...
  /// \brief Creates an initializes a new GpsCompassEstimatedBaselineRegister
  /// structure.
  ///
  /// \param[in] estBaselineUsedIn Value to initialize the estBaselineUsed field
  /// with. \param[in] numMeasIn Value to initialize the numMeas field with.
  /// \param[in] positionIn Value to initialize the position field with.
  /// \param[in] uncertaintyIn Value to initialize the uncertainty field with.
  GpsCompassEstimatedBaselineRegister(bool estBaselineUsedIn,
                                      uint16_t numMeasIn,
                                      vn::math::vec3f positionIn,
                                      vn::math::vec3f uncertaintyIn)
      : estBaselineUsed(estBaselineUsedIn), numMeas(numMeasIn),
        position(positionIn), uncertainty(uncertaintyIn) {}
};
...
struct ImuRateConfigurationRegister {
  ...
  /// \brief Creates an initializes a new ImuRateConfigurationRegister
  /// structure.
  ///
  ...
  /// \param[in] filterTargetRateIn Value to initialize the filterTargetRate
  /// field with. \param[in] filterMinRateIn Value to initialize the
  /// filterMinRate field with.
  ImuRateConfigurationRegister(uint16_t imuRateIn, uint16_t navDivisorIn,
                               float filterTargetRateIn, float filterMinRateIn)
      : imuRate(imuRateIn), navDivisor(navDivisorIn),
        filterTargetRate(filterTargetRateIn), filterMinRate(filterMinRateIn) {}
};

/// \brief Structure representing the Yaw, Pitch, Roll, True Body Acceleration
/// and Angular Rates register.
struct YawPitchRollTrueBodyAccelerationAndAngularRatesRegister {
  ...
  /// \brief Creates an initializes a new
  /// YawPitchRollTrueBodyAccelerationAndAngularRatesRegister structure.
  ///
  /// \param[in] yawPitchRollIn Value to initialize the yawPitchRoll field with.
  /// \param[in] bodyAccelIn Value to initialize the bodyAccel field with.
  /// \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollTrueBodyAccelerationAndAngularRatesRegister(
      vn::math::vec3f yawPitchRollIn, vn::math::vec3f bodyAccelIn,
      vn::math::vec3f gyroIn)
      : yawPitchRoll(yawPitchRollIn), bodyAccel(bodyAccelIn), gyro(gyroIn) {}
};

/// \brief Structure representing the Yaw, Pitch, Roll, True Inertial
...
struct YawPitchRollTrueInertialAccelerationAndAngularRatesRegister {
  ...
  /// \brief Creates an initializes a new
  /// YawPitchRollTrueInertialAccelerationAndAngularRatesRegister structure.
  ///
  /// \param[in] yawPitchRollIn Value to initialize the yawPitchRoll field with.
  /// \param[in] inertialAccelIn Value to initialize the inertialAccel field
  /// with. \param[in] gyroIn Value to initialize the gyro field with.
  YawPitchRollTrueInertialAccelerationAndAngularRatesRegister(
      vn::math::vec3f yawPitchRollIn, vn::math::vec3f inertialAccelIn,
      vn::math::vec3f gyroIn)
      : yawPitchRoll(yawPitchRollIn), inertialAccel(inertialAccelIn),
        gyro(gyroIn) {}
};
