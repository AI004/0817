...
public:
...
#if PYTHON
  typedef Event<protocol::uart::Packet &, size_t, xplat::TimeStamp>
      AsyncPacketReceivedEvent;
#endif
  ...
  typedef void (*RawDataReceivedHandler)(void *userData, const char *rawData,
                                         size_t length, size_t runningIndex);

  /// \brief Defines the signature for a method that can receive
  /// notifications of new possible packets found.
  ///
  /// \param[in] userData Pointer to user data that was initially supplied
  ///     when the callback was registered via
  ///     registerPossiblePacketFoundHandler.
  ...
  typedef void (*PossiblePacketFoundHandler)(
      void *userData, protocol::uart::Packet &possiblePacket,
  ...
  /// \brief Checks if we are able to send and receive communication with a
  /// sensor.
  ///
  /// \return <c>true</c> if we can communicate with the sensor; otherwise
  /// <c>false</c>.
  ...
  /// \brief Sends the provided command and returns the response from the
  /// sensor.
  ///
  /// If the command does not have an asterisk '*', then a checksum will be
  /// performed and appended based on the current error detection mode. Also, if
  /// the line-ending
  ...
  std::string send(std::string toSend, bool waitForReply = true,
  ...
  /// \brief Command to inform the VectorNav Sensor if there is a magnetic
  /// disturbance present.
  ///
  /// \param[in] disturbancePresent Indicates the presence of a magnetic
  /// disturbance \param[in] waitForReply Indicates if the method should wait
  /// for a
  ///     response from the sensor.
  void magneticDisturbancePresent(bool disturbancePresent,
                                  bool waitForReply = true);

  /// \brief Command to inform the VectorNav Sensor if there is an acceleration
  /// disturbance present.
  ///
  /// \param[in] disturbancePresent Indicates the presense of an acceleration
  /// disturbance. \param[in] waitForReply Indicates if the method should wait
  /// for a
  ///     response from the sensor.
  void accelerationDisturbancePresent(bool disturbancePresent,
                                      bool waitForReply = true);
  ...
  void registerRawDataReceivedHandler(void *userData,
...
// Event event
  ...
  ///     callback method.
  /// \param[in] handler The callback method.
  void registerPossiblePacketFoundHandler(void *userData,
  ...
  ///     callback method.
  /// \param[in] handler The callback method.
  void registerAsyncPacketReceivedHandler(void *userData,
...
// Event<protocol::uart::Packet&, size_t, size_t> eventAsyncPacketRecieved;
  ...
  ///     callback method.
  /// \param[in] handler The callback method.
  void registerErrorPacketReceivedHandler(void *userData,
  ...
  /// from the sensor.
  void writeBinaryOutput1(BinaryOutputRegister &fields,
                          bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeBinaryOutput2(BinaryOutputRegister &fields,
                          bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeBinaryOutput3(BinaryOutputRegister &fields,
                          bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeSerialBaudRate(const uint32_t &baudrate, uint8_t port,
                           bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAsyncDataOutputType(protocol::uart::AsciiAsync ador, uint8_t port,
                                bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAsyncDataOutputFrequency(const uint32_t &adof, uint8_t port,
                                     bool waitForReply = true);
  ...
  /// from the sensor.
  void
  writeInsBasicConfigurationVn200(InsBasicConfigurationRegisterVn200 &fields,
                                  bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeInsBasicConfigurationVn200(protocol::uart::Scenario scenario,
  ...
  /// from the sensor.
  void
  writeInsBasicConfigurationVn300(InsBasicConfigurationRegisterVn300 &fields,
                                  bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeInsBasicConfigurationVn300(protocol::uart::Scenario scenario,
                                       const uint8_t &ahrsAiding,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAsyncDataOutputType(protocol::uart::AsciiAsync ador,
                                bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAsyncDataOutputFrequency(const uint32_t &adof,
                                     bool waitForReply = true);
  ...
  /// \brief Reads the Quaternion, Magnetic, Acceleration and Angular Rates
  /// register.
  ///
  /// \return The register's values.
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeMagneticAndGravityReferenceVectors(const vn::math::vec3f &magRef,
  ...
  readFilterMeasurementsVarianceParameters();
  ...
  void writeFilterMeasurementsVarianceParameters(
      FilterMeasurementsVarianceParametersRegister &fields,
      bool waitForReply = true);
  ...
  void writeFilterMeasurementsVarianceParameters(
      ...
      const vn::math::vec3f &accelerationVariance, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeMagnetometerCompensation(MagnetometerCompensationRegister &fields,
                                     bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeMagnetometerCompensation(const vn::math::mat3f &c,
  ...
  /// \brief Writes to the Filter Active Tuning Parameters register.
  ///
  /// \param[in] magneticDisturbanceGain Value for the Magnetic Disturbance Gain
  /// field. \param[in] accelerationDisturbanceGain Value for the Acceleration
  /// Disturbance Gain field. \param[in] magneticDisturbanceMemory Value for the
  /// Magnetic Disturbance Memory field. \param[in]
  /// accelerationDisturbanceMemory Value for the Acceleration Disturbance
  /// Memory field. \param[in] waitForReply Indicates if the method should wait
  /// for a response from the sensor.
  void
  writeFilterActiveTuningParameters(const float &magneticDisturbanceGain,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAccelerationCompensation(AccelerationCompensationRegister &fields,
                                     bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeAccelerationCompensation(const vn::math::mat3f &c,
                                     const vn::math::vec3f &b,
                                     bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeReferenceFrameRotation(const vn::math::mat3f &c,
                                   bool waitForReply = true);

  /// \brief Reads the Yaw, Pitch, Roll, Magnetic, Acceleration and Angular
  /// Rates register.
  ///
  /// \return The register's values.
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeSynchronizationControl(SynchronizationControlRegister &fields,
                                   bool waitForReply = true);
  ...
  void writeSynchronizationControl(
      ...
      protocol::uart::SyncInEdge syncInEdge, const uint16_t &syncInSkipFactor,
      protocol::uart::SyncOutMode syncOutMode,
      protocol::uart::SyncOutPolarity syncOutPolarity,
      const uint16_t &syncOutSkipFactor, const uint32_t &syncOutPulseWidth,
      bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeSynchronizationStatus(SynchronizationStatusRegister &fields,
                                  bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeSynchronizationStatus(const uint32_t &syncInCount,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeFilterBasicControl(FilterBasicControlRegister &fields,
                               bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeFilterBasicControl(protocol::uart::MagneticMode magMode,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeBasicControl(VpeBasicControlRegister &fields,
                            bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeBasicControl(protocol::uart::VpeEnable enable,
  ...
  /// from the sensor.
  void
  writeVpeMagnetometerBasicTuning(VpeMagnetometerBasicTuningRegister &fields,
                                  bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeMagnetometerBasicTuning(const vn::math::vec3f &baseTuning,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeMagnetometerAdvancedTuning(const vn::math::vec3f &minFiltering,
  ...
  /// from the sensor.
  void
  writeVpeAccelerometerBasicTuning(VpeAccelerometerBasicTuningRegister &fields,
                                   bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeAccelerometerAdvancedTuning(const vn::math::vec3f &minFiltering,
                                           const vn::math::vec3f &maxFiltering,
                                           const float &maxAdaptRate,
                                           const float &disturbanceWindow,
                                           const float &maxTuning,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeGyroBasicTuning(VpeGyroBasicTuningRegister &fields,
                               bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVpeGyroBasicTuning(const vn::math::vec3f &angularWalkVariance,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeFilterStartupGyroBias(const vn::math::vec3f &bias,
                                  bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeMagnetometerCalibrationControl(protocol::uart::HsiMode hsiMode,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeIndoorHeadingModeControl(const float &maxRateError,
                                     bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeVelocityCompensationMeasurement(const vn::math::vec3f &velocity,
                                            bool waitForReply = true);
  ...
  /// from the sensor.
  void
  writeVelocityCompensationControl(VelocityCompensationControlRegister &fields,
                                   bool waitForReply = true);
  ...
  void writeVelocityCompensationControl(
      ...
      const float &velocityTuning, const float &rateTuning,
      bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGpsConfiguration(GpsConfigurationRegister &fields,
                             bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGpsConfiguration(protocol::uart::GpsMode mode,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGpsAntennaOffset(const vn::math::vec3f &position,
                             bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeInsAdvancedConfiguration(InsAdvancedConfigurationRegister &fields,
                                     bool waitForReply = true);
  ...
  void writeInsAdvancedConfiguration(
      ...
      const uint8_t &velAtt, const uint8_t &velBias,
      protocol::uart::FoamInit useFoam, const uint8_t &gpsCovType,
      const uint8_t &velCount, const float &velInit, const float &moveOrigin,
      const float &gpsTimeout, const float &deltaLimitPos,
      const float &deltaLimitVel, const float &minPosUncertainty,
      const float &minVelUncertainty, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeStartupFilterBiasEstimate(StartupFilterBiasEstimateRegister &fields,
                                      bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeStartupFilterBiasEstimate(const vn::math::vec3f &gyroBias,
  ...
  readDeltaThetaAndDeltaVelocityConfiguration();

  /// \brief Writes to the Delta Theta and Delta Velocity Configuration
  /// register.
  ///
  /// \param[in] fields The register's fields.
  /// \param[in] waitForReply Indicates if the method should wait for a response
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeReferenceVectorConfiguration(const uint8_t &useMagModel,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGyroCompensation(GyroCompensationRegister &fields,
                             bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGyroCompensation(const vn::math::mat3f &c, const vn::math::vec3f &b,
                             bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeImuFilteringConfiguration(ImuFilteringConfigurationRegister &fields,
                                      bool waitForReply = true);
  ...
  void writeImuFilteringConfiguration(
      ...
      protocol::uart::FilterMode presFilterMode, bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGpsCompassBaseline(GpsCompassBaselineRegister &fields,
                               bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeGpsCompassBaseline(const vn::math::vec3f &position,
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeImuRateConfiguration(ImuRateConfigurationRegister &fields,
                                 bool waitForReply = true);
  ...
  /// \param[in] waitForReply Indicates if the method should wait for a response
  /// from the sensor.
  void writeImuRateConfiguration(const uint16_t &imuRate,
                                 const uint16_t &navDivisor,
                                 const float &filterTargetRate,
                                 const float &filterMinRate,
                                 bool waitForReply = true);

  /// \brief Reads the Yaw, Pitch, Roll, True Body Acceleration and Angular
  /// Rates register.
  ///
  /// \return The register's values.
  ...
  /// \brief Reads the Yaw, Pitch, Roll, True Inertial Acceleration and Angular
  /// Rates register.
  ///
  /// \return The register's values.
