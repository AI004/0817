...
/// \brief Useful test class for taking place where \ref vn::common::ISimplePort
/// may be
///     used.
class MemoryPort : public xplat::IPort, private NoCopy {
  typedef void (*DataWrittenHandler)(void *userData, const char *rawData,
                                     size_t length);
...
public:
  ...
  virtual void read(char dataBuffer[], size_t numOfBytesToRead,
                    size_t &numOfBytesActuallyRead);

  virtual void registerDataReceivedHandler(void *userData,
