...
public:
  /// \brief Returns the orientation as represented in yaw, pitch, roll in
  /// degrees. \return The orientation in yaw, pitch, roll in degrees.
  vec3f yprInDegs();

  /// \brief Returns the orientation as represented in yaw, pitch, roll in
  /// radians. \return The orientation in yaw, pitch, roll in radians.
  vec3f yprInRads();
  ...
  /// \brief Returns the orientation as represented by a direction cosine
  /// matrix. \return The orientation as a direction cosine matrix.
  mat3f dcm();
