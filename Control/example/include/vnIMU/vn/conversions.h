...
template <size_t dim> vec<dim, float> rad2deg(vec<dim> anglesInRads) {
...
template <size_t dim> vec<dim, float> deg2rad(vec<dim> anglesInDegs) {
  for (size_t i = 0; i < dim; i++)
...
/// \brief Converts an orientation represented as a yaw, pitch, roll in degrees
/// to a quaternion.
///
...
/// \brief Converts an orientation represented as a yaw, pitch, roll in radians
/// to a quaternion.
///
...
/// \brief Converts from direction cosine matrix to omega, phi, kappa
/// representation.
///
/// \param[in] dcm The direction cosine matrix.
/// \return The omega, phi, kappa representation in radians.
...
/// \brief Converts from yaw, pitch, roll in degrees to omega, phi, kappa
/// representation.
///
...
/// \brief Converts from yaw, pitch, roll in radians to omega, phi, kappa
/// representation.
///
