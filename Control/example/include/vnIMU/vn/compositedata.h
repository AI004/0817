...
/// \brief Composite structure of all data types available from VectorNav
/// sensors.
...
public:
  ...
  /// \return <c>true</c> if <c>anyAttitude</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyAttitude();

  /// \brief Gets and converts the latest attitude data regardless of the
  /// received underlying type. Based on which type of attitude data that was
  /// last received and processed, this value may be based on either received
  /// yaw, pitch, roll, quaternion, or direction cosine matrix data.
  ///
  ...
  /// \return <c>true</c> if <c>yawPitchRoll</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>quaternion</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasQuaternion();
  ...
  /// \return <c>true</c> if <c>directionCosineMatrix</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyMagnetic</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyMagnetic();

  /// \brief Gets and converts the latest magnetic data regardless of the
  /// received underlying type. Based on which type of magnetic data that was
  /// last received and processed, this value may be based on either received
  /// magnetic or magneticUncompensated data.
  ///
  ...
  /// \return <c>true</c> if <c>magnetic</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasMagnetic();
  ...
  /// \return <c>true</c> if <c>magneticUncompensated</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>magneticNed</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasMagneticNed();
  ...
  /// \return <c>true</c> if <c>magneticEcef</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyAcceleration</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyAcceleration();

  /// \brief Gets and converts the latest acceleration data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>acceleration</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationLinearBody</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationUncompensated</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationLinearNed</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationLinearEcef</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationNed</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>accelerationEcef</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyAngularRate</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyAngularRate();

  /// \brief Gets and converts the latest angular rate data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>angularRate</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAngularRate();
  ...
  /// \return <c>true</c> if <c>angularRateUncompensated</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyTemperature</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyTemperature();

  /// \brief Gets and converts the latest temperature data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>temperature</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTemperature();
  ...
  /// \return <c>true</c> if <c>anyPressure</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyPressure();

  /// \brief Gets and converts the latest pressure data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>pressure</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasPressure();
  ...
  /// \return <c>true</c> if <c>anyPosition</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyPosition();
  ...
  /// \return <c>true</c> if <c>positionGpsLla</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasPositionGpsLla();

  /// \brief Indicates if <c>positionGps2Lla</c> has valid data.
  /// \return <c>true</c> if <c>positionGps2Lla</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>positionGpsEcef</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasPositionGpsEcef();

  /// \brief Indicates if <c>positionGps2Ecef</c> has valid data.
  /// \return <c>true</c> if <c>positionGps2Ecef</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>positionEstimatedLla</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>positionEstimatedEcef</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyVelocity</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasAnyVelocity();
  ...
  /// \return <c>true</c> if <c>velocityGpsNed</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasVelocityGpsNed();

  /// \brief Indicates if <c>velocityGps2Ned</c> has valid data.
  /// \return <c>true</c> if <c>velocityGps2Ned</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>velocityGpsEcef</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasVelocityGpsEcef();

  /// \brief Indicates if <c>velocityGps2Ecef</c> has valid data.
  /// \return <c>true</c> if <c>velocityGps2Ecef</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>velocityEstimatedNed</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>velocityEstimatedEcef</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>velocityEstimatedBody</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>deltaTime</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasDeltaTime();
  ...
  /// \return <c>true</c> if <c>deltaTheta</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasDeltaTheta();
  ...
  /// \return <c>true</c> if <c>deltaVelocity</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>timeStartup</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeStartup();
  ...
  /// \return <c>true</c> if <c>timeGps</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeGps();

  /// \brief Indicates if <c>timeGps2</c> has valid data.
  /// \return <c>true</c> if <c>timeGps2</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeGps2();
  ...
  /// \return <c>true</c> if <c>numSats</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasNumSats();
  ...
  /// \return <c>true</c> if <c>timeSyncIn</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeSyncIn();
  ...
  /// \return <c>true</c> if <c>vpeStatus</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasVpeStatus();
  ...
  /// \return <c>true</c> if <c>insStatus</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasInsStatus();
  ...
  /// \return <c>true</c> if <c>syncInCnt</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasSyncInCnt();
  ...
  /// \return <c>true</c> if <c>syncOutCnt</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasSyncOutCnt();
  ...
  /// \return <c>true</c> if <c>timeStatus</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeStatus();
  ...
  /// \return <c>true</c> if <c>timeGpsPps</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeGpsPps();

  /// \brief Indicates if <c>timeGps2Pps</c> has valid data.
  /// \return <c>true</c> if <c>timeGps2Pps</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeGps2Pps();
  ...
  /// \return <c>true</c> if <c>gpsTow</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasGpsTow();

  /// \brief Indicates if <c>gps2Tow</c> has valid data.
  /// \return <c>true</c> if <c>gps2Tow</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasGps2Tow();
  ...
  /// \return <c>true</c> if <c>timeUtc</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasTimeUtc();
  ...
  /// \return <c>true</c> if <c>sensSat</c> has valid data; otherwise
  /// <c>false</c>.
  bool hasSensSat();
  ...
  /// \return <c>true</c> if <c>anyPositionUncertainty</c> has valid data;
  /// otherwise <c>false</c>.
  bool hasAnyPositionUncertainty();

  /// \brief Gets the latest position uncertainty data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>positionUncertaintyGpsNed</c> has valid data;
  /// otherwise <c>false</c>.
  bool hasPositionUncertaintyGpsNed();

  /// \brief Indicates if <c>positionUncertaintyGps2Ned</c> has valid data.
  /// \return <c>true</c> if <c>positionUncertaintyGps2Ned</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>positionUncertaintyGpsEcef</c> has valid data;
  /// otherwise <c>false</c>.
  bool hasPositionUncertaintyGpsEcef();

  /// \brief Indicates if <c>positionUncertaintyGps2Ecef</c> has valid data.
  /// \return <c>true</c> if <c>positionUncertaintyGps2Ecef</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>positionUncertaintyEstimated</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>anyVelocityUncertainty</c> has valid data;
  /// otherwise <c>false</c>.
  bool hasAnyVelocityUncertainty();

  /// \brief Gets the latest velocity uncertainty data regardless of the
  /// received underlying type.
  ///
  ...
  /// \return <c>true</c> if <c>velocityUncertaintyGps</c> has valid data;
  /// otherwise <c>false</c>.
  bool hasVelocityUncertaintyGps();

  /// \brief Indicates if <c>velocityUncertaintyGps2</c> has valid data.
  /// \return <c>true</c> if <c>velocityUncertaintyGps2</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>velocityUncertaintyEstimated</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>timeUncertainty</c> has valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>attitudeUncertainty</c> has valid data;
  /// otherwise <c>false</c>.
  ...
  /// \return <c>true</c> if <c>courseOverGround</c> havs valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>speedOverGround</c> havs valid data; otherwise
  /// <c>false</c>.
  ...
  /// \return <c>true</c> if <c>timeInfo</c> havs valid data; otherwise
  /// <c>false</c>.
  bool hasTimeInfo();
...
private:
  static void parseBinary(protocol::uart::Packet &p,
                          std::vector<CompositeData *> &o);
  static void parseAscii(protocol::uart::Packet &p,
                         std::vector<CompositeData *> &o);
  static void parseBinaryPacketCommonGroup(protocol::uart::Packet &p,
                                           protocol::uart::CommonGroup gf,
                                           std::vector<CompositeData *> &o);
  static void parseBinaryPacketTimeGroup(protocol::uart::Packet &p,
                                         protocol::uart::TimeGroup gf,
                                         std::vector<CompositeData *> &o);
  static void parseBinaryPacketImuGroup(protocol::uart::Packet &p,
                                        protocol::uart::ImuGroup gf,
                                        std::vector<CompositeData *> &o);
  static void parseBinaryPacketGpsGroup(protocol::uart::Packet &p,
                                        protocol::uart::GpsGroup gf,
                                        std::vector<CompositeData *> &o);
  static void parseBinaryPacketAttitudeGroup(protocol::uart::Packet &p,
                                             protocol::uart::AttitudeGroup gf,
                                             std::vector<CompositeData *> &o);
  static void parseBinaryPacketInsGroup(protocol::uart::Packet &p,
                                        protocol::uart::InsGroup gf,
                                        std::vector<CompositeData *> &o);
  static void parseBinaryPacketGps2Group(protocol::uart::Packet &p,
                                         protocol::uart::GpsGroup gf,
                                         std::vector<CompositeData *> &o);
...
private:
  ...
  template <typename T>
  static void setValues(T val, std::vector<CompositeData *> &o,
                        void (Impl::*function)(T)) {
    for (std::vector<CompositeData *>::iterator i = o.begin(); i != o.end();
         ++i)
      (*((*i)->_i).*function)(val);
  }
};
