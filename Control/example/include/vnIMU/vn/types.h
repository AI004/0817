...
enum AsciiAsync {
  ...
  VNQMA =
      6, ///< Asynchronous output type is Quaternion, Magnetic and Acceleration.
  VNQAR = 7, ///< Asynchronous output type is Quaternion, Acceleration and
             ///< Angular Rates.
#endif
  VNQMR = 8, ///< Asynchronous output type is Quaternion, Magnetic, Acceleration
             ///< and Angular Rates.
#ifdef INTERNAL
  VNDCM =
      9, ///< Asynchronous output type is Directional Cosine Orientation Matrix.
#endif
  ...
  VNMAR = 13, ///< Asynchronous output type is Magnetic, Acceleration, and
              ///< Angular Rate Measurements.
  VNYMR = 14, ///< Asynchronous output type is Yaw, Pitch, Roll, Magnetic,
              ///< Acceleration, and Angular Rate Measurements.
#ifdef INTERNAL
  VNYCM = 15, ///< Asynchronous output type is Yaw, Pitch, Roll, and Calibrated
              ///< Measurements.
#endif
  VNYBA = 16, ///< Asynchronous output type is Yaw, Pitch, Roll, Body True
              ///< Acceleration.
  VNYIA = 17, ///< Asynchronous output type is Yaw, Pitch, Roll, Inertial True
              ///< Acceleration.
#ifdef INTERNAL
  VNICM = 18, ///< Asynchronous output type is Yaw, Pitch, Roll, Inertial
  ...
  VNCOV = 255, ///< Asynchronous output type is Kalman Filter Covariance Matrix
               ///< Diagonal.
#endif
};
...
/// \brief Different modes for the SyncInMode field of the Synchronization
/// Control register.
enum SyncInMode {
#ifdef INTERNAL
  /// \brief Count the number of trigger events on SYNC_IN_2 pin.
  /// \deprecated This option is obsolete for VN-100 firmware version 2.0 and
  /// greater and VN-200 firmware version 1.0 and greater.
  SYNCINMODE_COUNT2 = 0,
...
/// \brief Different modes for the SyncInEdge field of the Synchronization
/// Control register.
enum SyncInEdge {
...
/// \brief Different modes for the SyncOutMode field of the Synchronization
/// Control register.
enum SyncOutMode {
  /// \brief None.
  SYNCOUTMODE_NONE = 0,
...
/// \brief Different modes for the SyncOutPolarity field of the Synchronization
/// Control register.
...
enum FilterMode {
  ...
  /// \brief Filtering performed on both uncompensated and compensated IMU
  /// measurements.
  FILTERMODE_BOTH = 3
};

/// \brief Integration frames for the Delta Theta and Delta Velocity
...
/// \brief Compensation modes for the Delta Theta and Delta Velocity
/// configuration register.
...
enum ExternalSensorMode {
  ...
  /// \brief Use external magnetometer. Will use measurement at every new time
  /// step.
  EXTERNALSENSORMODE_EXTERNAL200HZ = 1,
  /// \brief Use external magnetometer. Will only use when the measurement is
  /// updated.
...
enum InsStatus {
  ...
  INSSTATUS_SUFFICIENT_DYNAMIC_MOTION =
      0x01,                    ///< \brief Sufficient dynamic motion.
  ...
  INSSTATUS_MAG_PRES_ERROR =
      0x20,                  ///< \brief Magnetometer or pressure sensor error.
